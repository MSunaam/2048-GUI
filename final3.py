...
#for main screen height and width
window_width = 1200
window_height = 800

#for center black grids height and width
grid_width = 500
grid_height = 500
...
def game():
    ...
    #for colors---generating a dict with keys for tiles and their specific RGB values
    ...
    colorDic = {2:color2,4:color4,8:color8,16:color16,32:color32,64:color64,128:color128,256:color256,512:color512,1024:color1024,2048:color2048,'text':text}


    #x y coordinates of each tile
    coordinates = [
    [(370,220),(490,220),(610,220),(730,220)],
    [(370,340),(490,340),(610,340),(730,340)],
    [(370,460),(490,460),(610,460),(730,460)],
    [(370,580),(490,580),(610,580),(730,580)],
    ]
    ...
    def updateScreen():
        ...
        reload_img = pygame.image.load("reset.png")
        ...
        save_img = pygame.image.load("diskette.png")
        ...
        save_file_img = pygame.image.load("loadGame.png")
